  ...
  return (
    <div className="bg-legal-dark/80 dark:bg-legal-dark-alt/60 backdrop-blur-sm rounded-xl border border-legal-blue/30 shadow-blue flex flex-col h-[700px]">
      ...
      <div className="p-4 border-b border-legal-blue/20 flex items-center bg-gradient-to-r from-legal-blue/10 to-transparent rounded-t-xl">
        <motion.div 
          className="w-10 h-10 rounded-full bg-gradient-to-br from-legal-gold/30 to-legal-gold/10 flex items-center justify-center mr-3 border border-legal-gold/30"
          initial={{ rotate: -10 }}
          animate={{ rotate: 0 }}
        ...
        <div className="ml-auto flex items-center gap-2">
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="p-2 hover:bg-legal-blue/10 rounded-lg transition-colors flex items-center gap-1 text-xs border border-transparent hover:border-legal-blue/20" 
      ...
      >
        ...
        {sendMessageMutation.isPending && (
          <motion.div 
            className="chat-message bg-gradient-to-br from-legal-dark-alt/90 to-legal-dark/80 dark:from-legal-dark/90 dark:to-legal-dark-alt/80 rounded-lg self-start mr-auto max-w-[80%] p-4 shadow-sm"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
