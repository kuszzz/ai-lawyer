      ...
      >
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <Link href="/upload">
              <div 
                className="px-4 py-1.5 bg-legal-gold text-legal-dark rounded-lg text-sm font-medium flex items-center cursor-pointer"
              >
            ...
            <div className="container mx-auto py-6 px-4">
              <nav className="flex flex-col space-y-4">
                {navItems.map((item) => (
                  <Link key={item.path} href={item.path}>
                    <div 
                      className={`py-2 px-4 rounded-lg ${location === item.path ? 'bg-legal-blue/20 text-legal-gold' : 'text-legal-text'} cursor-pointer`}
                ...
                <div className="flex justify-between items-center pt-4 border-t border-legal-blue/20 mt-2">
                  ...
                  <Link href="/upload">
                    <div 
                      className="px-4 py-2 bg-legal-gold text-legal-dark rounded-lg text-sm font-medium flex items-center cursor-pointer"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      <i className="ri-upload-2-line mr-1"></i> Upload Case
                    </div>
